...
private val SlotellyLightColors = lightColorScheme(
    primary = Color(0xFF7A3157),
    onPrimary = Color.White,
    primaryContainer = Color(0xFFF0E5EB),
    onPrimaryContainer = Color(0xFF32101F),
    secondary = Color(0xFF66558D),
    onSecondary = Color.White,
    secondaryContainer = Color(0xFFEDE8F7),
    onSecondaryContainer = Color(0xFF241C38),
    tertiary = Color(0xFF77645B),
    tertiaryContainer = Color(0xFFF1E8E3),
    background = Color(0xFFFFFDFC),
    onBackground = Color(0xFF211A1E),
    surface = Color(0xFFFFFDFC),
    onSurface = Color(0xFF211A1E),
    surfaceVariant = Color(0xFFF4F1F3),
    onSurfaceVariant = Color(0xFF51484D),
    outline = Color(0xFF81747A),
    outlineVariant = Color(0xFFD8CFD3),
...
private fun NativeSlotellyRoot(repo: SlotellyRepository) {
    ...
    if(showAvailability)AvailabilityOverlay(initialDate=java.time.LocalDate.now(java.time.ZoneId.of("Europe/Moscow")),overrides=overrides,appointments=appts,repo=repo,pin=pin,onClose={showAvailability=false})
